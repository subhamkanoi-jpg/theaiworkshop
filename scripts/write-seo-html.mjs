...
const fallbacks = {
  ...
  path: `
      ...
      <h3>Sources</h3>
      <p><a href="https://en.wikipedia.org/wiki/Bidhannagar">Bidhannagar (Salt Lake)</a>. <a href="/kolkata">Learn AI in Kolkata</a>. <a href="/workshop">27 September</a>. <a href="/about">About</a>.</p>`,
  room: `
  ...
  host: `
      ...
      <h2>Place</h2>
      <p>Salt Lake, Kolkata, West Bengal 700064. Phone +91 98307 15557. <a href="https://en.wikipedia.org/wiki/Bidhannagar">Bidhannagar</a>. <a href="/about">About</a>. <a href="/workshop">27 September</a>.</p>`,
  kolkata: `
      ...
      <ul>
        <li><a href="/workshop">27 September. The Magic of AI</a></li>
        <li><a href="/about">About The AI Workshop</a></li>
        <li><a href="/book">Reserve a seat</a></li>
      </ul>`,
  about: `
      ...
      <h2>Place</h2>
      <p>Salt Lake is Bidhannagar, a planned township in the Kolkata metropolitan area. Read <a href="https://en.wikipedia.org/wiki/Bidhannagar">Bidhannagar on Wikipedia</a>. Local page: <a href="/kolkata">Learn AI in Kolkata</a>. <a href="/workshop">27 September</a>.</p>`,
  answers: `
...
${elmo.prompts
  ...
  share: `
      <h1>The AI Workshop</h1>
      <p>Kolkata's offline AI workshop in Salt Lake. A beginner walks in, builds a real thing, and comes back.</p>
      <h2>Vision</h2>
      <p>Kolkata's default place to learn applied AI with your own hands. Offline. A store, not a webinar.</p>
      <h2>Mission</h2>
      <p>One Sunday, one trick, one artifact. You talk. You walk out with work that did not exist at 11am. You open it on Tuesday.</p>
      <h3>Workshop #3. The Magic of AI</h3>
      <p>Sunday 27 September 2026, 11:00 to 14:00, Salt Lake, Kolkata. 50 seats. Community price ₹799.</p>
      <p><a href="/book">Reserve a seat</a>. <a href="/">Home</a>.</p>`,
};

function shell(page, { robots = "index, follow, max-image-preview:large", jsonLd = null, fallback = "" }) {
  const url = `${origin}${page.path}`;
  const ogImage = page.ogImage || `${origin}/og-card.jpg`;
  const ld = jsonLd
