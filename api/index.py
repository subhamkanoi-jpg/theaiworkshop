...
_FALLBACK = {
    ...
    "title": "Build Your AI Follow-up Assistant",
    "bringLabel": "a laptop and charger (recommended), a phone, a signed-in personal Google account, and anonymised work notes. Sample notes are available.",
